...
export type ProgressRow = { question_id:number|string; solved:boolean; hint_used:boolean; solution_seen:boolean; solved_at:string|null; last_viewed_at:string|null; code?:string|null; code_updated_at?:string|null };
